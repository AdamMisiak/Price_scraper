...
class CheckPriceForm(FlaskForm):
    ...
    #value_btc_usd = my_coin_value_usd(quantity_btc,check_price_btc())
    #value_xrp_usd = my_coin_value_usd(quantity_xrp,check_price_xrp())
    #value_xlm_usd = my_coin_value_usd(quantity_xlm,check_price_xlm())
    #value_gld_usd = my_coin_value_usd(quantity_gld,check_price_gld())
